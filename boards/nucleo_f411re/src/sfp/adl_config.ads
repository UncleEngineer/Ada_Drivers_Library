...
package ADL_Config is
   ...
   Device_Name                    : constant String  := "STM32F411RE";     -- From board definition
   ...
   Runtime_Name                   : constant String  := "ravenscar-sfp-nucleo_f411re"; -- From default value
   ...
   Board                          : constant String  := "NUCLEO_F411RE";     -- From command line
   ...
   Runtime_Name_Suffix            : constant String  := "nucleo_f411re";           -- From board definition
